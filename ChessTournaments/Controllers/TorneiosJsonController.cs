...
namespace ChessTournaments.Controllers
{
    ...
    [ApiController]
    public class TorneiosJsonController : ControllerBase
    {
        private readonly ApplicationDbContext _context;

        public TorneiosJsonController(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: api/TorneiosJson
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Torneio>>> GetTorneio()
        {
          if (_context.Torneio == null)
          {
            ...
            return await _context.Torneio.Include(t => t.Organizacao).ToListAsync();
        }

        // GET: api/TorneiosJson/5
        [HttpGet("{id}")]
