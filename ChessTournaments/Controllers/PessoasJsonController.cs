...
namespace ChessTournaments.Controllers
{
    ...
    [ApiController]
    public class PessoasJsonController : ControllerBase
    {
        private readonly ApplicationDbContext _context;

        public PessoasJsonController(ApplicationDbContext context)
        {
            _context = context;
        }
